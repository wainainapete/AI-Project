...
export const HeaderNav = (props) => {
    ...
    return (
        <Header
            ...
            css={css`
                background: linear-gradient(to right, rgb(243, 250, 250), rgb(162, 226, 235)); /* Gradient background color */
            `}
        >
                    ...
                    <NavEdge left>
                        <div
                            css={css`
                                ...
                                font-weight: bold;
                                margin-left: 20px;
                                background: linear-gradient(to right,rgb(85, 111, 114),rgb(240, 43, 247)); /* Gradient from left to right */
